    ...
    <div className='csv'>
        <div className="csv w-full h-full text-black text-xl font-bold flex flex-col overflow-y-auto flex-none px-2 py-2">
            <h3 className="text-center text-violet-300 font-medium text-lg mb-4">Upload Voters</h3>
                ...
                <input className="block w-full text-sm text-white cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 mb-5 border border-gray-400 py-[10px] px-3 rounded" id="file_input" type="file"/>
