...
const ElectionsListSingle = ({props}) => {
    ...
    return (
        <div className="h-[50px] w-full rounded-l-full rounded-r-full bg-violet-600 flex my-[2px] py-1" key={"div" + idx}>
            <div className="w-1/2 py-3 pl-5 pr-2 h-full" key={"div-left" + idx}>
