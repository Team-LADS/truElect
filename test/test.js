...
//         await expect(votingContract.connect(thirdAddress).uploadListOfVoters("electionCommittee",2,[secondAddress.address])).to.be.revertedWith("Access granted to only the election committee head or member of the election committee");
//         console.log('\t',"Passed ...."); 
//     });
...
//         await expect(votingContract.connect(thirdAddress).uploadListOfVoters("electionCommittee",2,[fourthAddress.address])).to.be.revertedWith("Access granted to only the election committee head or member of the election committee");
//         console.log('\t',"Passed ....");
//     });
...
//         await expect(votingContract.connect(fourthAddress).registerNewCandidate("Godand","chancellor")).to.be.revertedWith("Access granted to only the election committee head or member of the election committee");
//         console.log('\t',"Passed ....");
//     });
...
//         await expect(votingContract.connect(fourthAddress).setUpAnElection("chancellor",[1,2],["electionCommHead","electionCommittee"])).to.be.revertedWith("Access granted to only the election committee head or member of the election committee");
//         console.log('\t',"Passed ....");
//     });
...
//         const firstVote = await votingContract.connect(owner).vote("chancellor",1);
//         await expect(votingContract.connect(owner).vote("chancellor",1)).to.be.revertedWith("Cannot vote twice for a category..");
//         console.log('\t',"Passed ....")
//     });
...
//         await expect(votingContract.connect(fifthAddress).collateVotes("senate")).to.be.revertedWith("Access granted to only the election committee head or member of the election committee");
//         console.log('\t',"passed")
        
//     });
//     it("Should not be able to Compiling Votes if caller is not a member of the election committee ",async function(){
//         const [owner,secondAddress,thirdAddress,fourthAddress,fifthAddress] = await ethers.getSigners();
//         console.log("\t","Attempting to Compiling Votes if caller is not the member of the election committee");
//         await expect(votingContract.connect(fourthAddress).collateVotes("senate")).to.be.revertedWith("Access granted to only the election committee head or member of the election committee");
//         console.log('\t',"passed")
//     });
...
//         setUpAnElection = await votingContract.connect(owner).setUpAnElection("counsellor",[6,7],["electionCommHead","electionCommittee","voter"]);
...
//         await expect(votingContract.connect(fifthAddress).broadcastResult("senate")).to.be.revertedWith("Access granted to only the election committee head, member of the election committee or member of the election committee");
//         console.log('\t',"Passed ....")
//     });
...
//         await expect(votingContract.connect(fourthAddress).broadcastResult("senate")).to.be.revertedWith("Access granted to only the election committee head, member of the election committee or member of the election committee");
//         console.log('\t',"Passed ....")
...
//         await expect(votingContract.connect(owner).broadcastResult("counsellor")).to.be.revertedWith("This session is still active, voting has not yet been counted");
//         console.log('\t',"Passed ....")
//     });
...
//         await expect(votingContract.connect(secondAddress).changeElectionCommHead(secondAddress.address)).to.be.revertedWith("Only member of the election committee have access");
//         console.log('\t',"Passed ....");
//     });
